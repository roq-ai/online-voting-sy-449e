...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['organization-owner', 'election-manager', 'system-administrator'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Elections', path: '/elections', entity: 'election', service: AccessServiceEnum.PROJECT, icon: FiCalendar },
