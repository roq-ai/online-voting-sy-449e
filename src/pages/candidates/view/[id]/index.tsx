...
import { useCandidateFindFirst, useRoqClient } from 'lib/roq';
...
function CandidateViewPage() {
  ...
  const queryParams = useMemo<{ include: { election: boolean } }>(
    () =>
  ...
  const { data, error, isLoading } = useCandidateFindFirst(queryParams, {}, { disabled: !id });
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem label="Votes" text={data?.votes} />
