...
import { useElectionFindFirst, useRoqClient } from 'lib/roq';
...
function ElectionViewPage() {
  ...
  const queryParams = useMemo<{ include: { client: boolean } }>(
    () =>
  ...
  const { data, error, isLoading } = useElectionFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('election', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/elections/edit/${id}`} passHref legacyBehavior>
                    <Button
