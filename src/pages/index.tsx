  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Online Voting System: Your Ultimate eVoting Solution for Government, Corporate, Association, Housing Society, and Student Elections. Experience the Best in Online Voting."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1494172961521-33799ddd43a5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx2b3Rpbmd8ZW58MHx8fHwxNjk3ODEwMDAwfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@ajaegers?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Arnaud Jaegers`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Online Voting System: Your Ultimate eVoting Solution for Government, Corporate, Association, Housing Society, and Student Elections. Experience the Best in Online Voting.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                ...
                <Card userTypeName="Voter" type="voter" abilities={appConfig.customerAbilities} />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
